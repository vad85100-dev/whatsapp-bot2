...
const styles = {
    ...
    солнышко: {
        h: '☀️✨☀️✨☀️✨☀️✨☀️✨\n✩⢄⢁✧ --------- ✧⡈⡠✩\n🌞🌞 *{price_full}₽➖{price_half}₽* 🌞🌞\n✩⢄⢁✧ --------- ✧⡈⡠✩\n☀️💥1️⃣💥☀️ 5️⃣0️⃣0️⃣0️⃣ ⭐️ {1}\n☀️✨2️⃣✨☀️ 1️⃣0️⃣0️⃣0️⃣ ✨ {2}\n☀️💥3️⃣💥☀️ 2️⃣0️⃣0️⃣0️⃣ 🌟 {3}\n☀️✨4️⃣✨☀️ 1️⃣5️⃣0️⃣0️⃣ 💫 {4}\n☀️💥5️⃣💥☀️ 1️⃣5️⃣0️⃣0️⃣ ⭐️ {5}\n☀️✨6️⃣✨☀️ 3️⃣0️⃣0️⃣0️⃣ ✨ {6}\n✩⢄⢁✧ --------- ✧⡈⡠✩\n{7} {8} {9} {10} {11}',
        i: '☀️',
    ...
    смерч: {
        h: '🌪️💨🌪️💨🌪️💨🌪️💨🌪️💨\n✩⢄⢁✧ --------- ✧⡈⡠✩\n🌪️🌪️ *{price_full}₽➖{price_half}₽* 🌪️🌪️\n✩⢄⢁✧ --------- ✧⡈⡠✩\n🌪️💥1️⃣💥🌪️ 2️⃣0️⃣0️⃣0️⃣ 💨 {1}\n🌪️✨2️⃣✨🌪️ 1️⃣0️⃣0️⃣0️⃣ 💨 {2}\n🌪️💥3️⃣💥🌪️ 1️⃣2️⃣0️⃣0️⃣ 💨 {3}\n🌪️✨4️⃣✨🌪️ 1️⃣2️⃣0️⃣0️⃣ 💨 {4}\n🌪️💥5️⃣💥🌪️ 2️⃣1️⃣0️⃣0️⃣ 💨 {5}\n✩⢄⢁✧ --------- ✧⡈⡠✩\n{6} {7} {8} {9} {10}',
        i: '🌪️',
        price: { full: 1000, half: 500 },
        maxNumbers: 10,
        prizesCount: 5,
    ...
    ледовик: {
        h: '❄️🧊❄️🧊❄️🧊❄️🧊❄️🧊\n✩⢄⢁✧ --------- ✧⡈⡠✩\n❄️❄️ *{price_full}₽➖{price_half}₽* ❄️❄️\n✩⢄⢁✧ --------- ✧⡈⡠✩\n❄️💥1️⃣💥❄️ 5️⃣5️⃣0️⃣0️⃣ 🧊 {1}\n❄️✨2️⃣✨❄️ 3️⃣0️⃣0️⃣0️⃣ 🧊 {2}\n❄️💥3️⃣💥❄️ 3️⃣0️⃣0️⃣0️⃣ 🧊 {3}\n❄️✨4️⃣✨❄️ 2️⃣0️⃣0️⃣0️⃣ 🧊 {4}\n❄️💥5️⃣💥❄️ 4️⃣0️⃣0️⃣0️⃣ 🧊 {5}\n✩⢄⢁✧ --------- ✧⡈⡠✩\n{6} {7} {8} {9} {10}',
        i: '❄️',
        price: { full: 2000, half: 1000 },
        maxNumbers: 10,
        prizesCount: 5,
...
function renderLot() {
    ...
    // Берём красивое оформление из стиля
    let res = s.h;
    
    // Подставляем цены (если в h есть {price_full} и {price_half})
    ...
    for (let i = 1; i <= game.max; i++) {
        ...
        let playerName = s.i + ' 🟢'; // По умолчанию свободно
        ...
        // Заменяем {номер} на имя игрока
        const pattern = new RegExp(`\\{${i}\\}`, 'g');
        res = res.replace(pattern, playerName);
    }
    
    // Если лот на паузе — добавляем информацию
    if (game.paused) {
        res += `\n\n⏸️ *ЛОТ НА ПАУЗЕ* ⏸️`;
